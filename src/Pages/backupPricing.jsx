        ...
        <div className="container py-3">
            ...
            <header>
                ...
                <div className="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 className="display-4 fw-normal text-warning" style={{color:'orange'}}>Wedding Video Pricing</h1>
                    {/* <p className="fs-5 text-muted">
                        You have been planning, dreaming and praying for this day your entire life, 
                        and it has finally arrived!</p>
                        <p className="fs-5 text-muted">I am ready to help you through every step of this thrilling,
                        emotional journey, so let's get connected. 
                    </p> */}
                </div>

                <div className="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 className="display-4 fw-normal text-warning" style={{color:'orange'}}>Commercial Video Pricing</h1>
                    {/* <p className="fs-5 text-muted">
                        You have been planning, dreaming and praying for this day your entire life, 
                        and it has finally arrived!</p>
                        <p className="fs-5 text-muted">I am ready to help you through every step of this thrilling,
