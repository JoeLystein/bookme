                            ...
                            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">                                    
                                        <img src={img1} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img2} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img3} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img4} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img5} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img6} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img7} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img8} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col">
                                    <div className="card mb-4 shadow-sm">
                                         <img src={img9} className="bd-placeholder-img card-img-top" width="100%" height="225" alt="logo"/>
                                        <div className="card-body">
                                            {/* <p class="card-text">This is a wider card with.</p> */}
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
